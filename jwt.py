...
TOKEN = os.getenv('7632003731:AAHUK67n0y1IEESvdB-UqBivNsR5wNVRRA4') # Prefer .env
if not TOKEN or TOKEN == "7632003731:AAHUK67n0y1IEESvdB-UqBivNsR5wNVRRA4": # Check if token is missing or placeholder
    # !!! Replace with your actual bot token if not using .env !!!
    TOKEN = "7632003731:AAHUK67n0y1IEESvdB-UqBivNsR5wNVRRA4" # FALLBACK - Highly recommended to use .env

# Optional: API Configuration
API_BASE_URL = os.getenv('JWT_API_URL', 'https://jwtgen-nine.vercel.app/token')#ƊƠƝƬ ƇӇƛƝƓЄ ƠƬӇЄƦƜƖƧЄ ЄƦƦƠƦ
API_KEY = os.getenv('JWT_API_KEY', '')

# Optional: Bot Settings
MAX_FILE_SIZE = int(os.getenv('MAX_FILE_SIZE', 5 * 1024 * 1024))  # 5MB default
ADMIN_ID = int(os.getenv('ADMIN_ID', 6091906014)) # Default to 0 (disabled) if not set or invalid
# Check and warn if ADMIN_ID is 0 but commands are expected
if ADMIN_ID == 6091906014:
...
ADMIN_CONTACT_LINK = os.getenv('ADMIN_CONTACT_LINK', 'https://t.me/Madara_Ghost_uchiha') # Default admin contact link
